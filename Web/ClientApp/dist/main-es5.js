(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CadastroClienteComponent = /** @class */ (function () {
                function CadastroClienteComponent(formBuilder, service, route, toastr) {
                ...
                CadastroClienteComponent.prototype.submitForm = function (cliente) {
                    var _this = this;
                    //Validação
                    var erro = false;
                    ...
                    if (!erro) {
                        this.service.salvarCliente(cliente).subscribe(function () { return _this.route.navigateByUrl('/clientes'); });
                    }
                };
                CadastroClienteComponent.prototype.voltar = function () {
                    this.route.navigateByUrl('/produtos');
                };
                return CadastroClienteComponent;
            }());
            CadastroClienteComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CadastroProdutoComponent = /** @class */ (function () {
                function CadastroProdutoComponent(formBuilder, service, route, toastr) {
                    this.formBuilder = formBuilder;
                    this.service = service;
                    this.route = route;
                    this.toastr = toastr;
                ...
                CadastroProdutoComponent.prototype.submitForm = function (produto) {
                    var _this = this;
                    //Validação
                    var erro = false;
                    ...
                    if (!erro) {
                        this.service.salvarProduto(produto).subscribe(function () { return _this.route.navigateByUrl('/produtos'); });
                    }
                };
                CadastroProdutoComponent.prototype.voltar = function () {
                    this.route.navigateByUrl('/produtos');
                };
                return CadastroProdutoComponent;
            }());
            CadastroProdutoComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CadastroUsuarioComponent = /** @class */ (function () {
                function CadastroUsuarioComponent(formBuilder, service, route, toastr) {
                    this.formBuilder = formBuilder;
                    this.service = service;
                    this.route = route;
                    this.toastr = toastr;
                ...
                CadastroUsuarioComponent.prototype.submitForm = function (usuario) {
                    var _this = this;
                    //Validação
                    ...
                    if (!erro) {
                        this.service.salvarUsuario(usuario).subscribe(function () { return _this.route.navigateByUrl('/clientes'); });
                    }
                };
                CadastroUsuarioComponent.prototype.voltar = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClientesComponent = /** @class */ (function () {
                function ClientesComponent(clientesService, dialog, router) {
                ...
                ClientesComponent.prototype.onResize = function (event) {
                    this.isMobile = event.target.innerWidth < 670;
                    this.verificaColunas();
                };
                ClientesComponent.prototype.ngOnChanges = function () {
                    this.paginar(null);
                    this.verificaColunas();
                };
                ClientesComponent.prototype.abrirPopUpExclusao = function (idCliente) {
                    var _this = this;
                    var dialogRef = this.dialog.open(_pop_up_confirm_pop_up_confirm_component__WEBPACK_IMPORTED_MODULE_2__["PopUpConfirmComponent"], { width: '250px', data: { idCliente: idCliente, tipoExclusao: 'cliente' } });
                    dialogRef.afterClosed().subscribe(function () { return _this.paginar(null); });
                };
                ClientesComponent.prototype.paginar = function (event) {
                    var _this = this;
                    var inicial;
                    var final;
                    if (event == null) {
                    ...
                    this.clientesService.consultarClientes().subscribe(function (data) {
                        _this.clientes = data;
                        _this.clientesPaginados = data.slice(inicial, final);
                    });
                };
                ClientesComponent.prototype.verificaColunas = function () {
                    if (this.isMobile)
                        this.displayedColumns = ['nome', 'ativo', 'controles'];
                    else
                        this.displayedColumns = ['nome', 'endereco', 'ativo', 'controles'];
                };
                ClientesComponent.prototype.usuarios = function (idCliente) {
                    this.router.navigate(['/usuarios'], { state: { idCliente: idCliente } });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClientesService = /** @class */ (function () {
                ...
                ClientesService.prototype.consultarClientes = function () {
                    return this.http.get(this.baseUrl + 'ConsultarClientes');
                };
                ClientesService.prototype.salvarCliente = function (cliente) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"];
                    headers.append('Content-Type', 'application/json');
                    return this.http.post(this.baseUrl + 'SalvarCliente', cliente, { headers: headers });
                };
                ClientesService.prototype.excluir = function (idCliente) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(formBuilder, usuarioService, router, toastr, cookie) {
                    this.formBuilder = formBuilder;
                ...
                LoginComponent.prototype.submitForm = function (login) {
                    var _this = this;
                    var erro = false;
                    ...
                    if (!erro) {
                        this.usuarioService.logar(login).subscribe(function (data) {
                            _this.cookie.set('usuario', JSON.stringify(data));
                            _this.router.navigateByUrl('/produtos', { state: { idCliente: data.idCliente } });
                        });
                    }
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavMenuComponent = /** @class */ (function () {
                function NavMenuComponent(cookie, router) {
                    this.cookie = cookie;
                    this.router = router;
                ...
                NavMenuComponent.prototype.redirect = function (url) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopUpConfirmComponent = /** @class */ (function () {
                function PopUpConfirmComponent(data, dialogRef, produtosService, clienteService, usuarioService) {
                    this.data = data;
                ...
                PopUpConfirmComponent.prototype.clickSim = function () {
                    var _this = this;
                    debugger;
                    switch (this.data.tipoExclusao) {
                        case 'produto':
                            this.produtosService.excluir(this.data.idProduto).subscribe(function () { return _this.dialogRef.close(); });
                            break;
                        case 'cliente':
                            this.clienteService.excluir(this.data.idCliente).subscribe(function () { return _this.dialogRef.close(); });
                            break;
                        case 'usuario':
                            this.usuarioService.excluir(this.data.idUsuario).subscribe(function () { return _this.dialogRef.close(); });
                            break;
                    }
                };
                PopUpConfirmComponent.prototype.clickNao = function () {
                    this.dialogRef.close();
                };
                return PopUpConfirmComponent;
            }());
            PopUpConfirmComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopUpComponent = /** @class */ (function () {
                function PopUpComponent(data, dialogRef, produtosService, toastr) {
                    this.data = data;
                    this.dialogRef = dialogRef;
                    this.produtosService = produtosService;
                    this.toastr = toastr;
                ...
                PopUpComponent.prototype.cancelar = function () {
                    this.dialogRef.close();
                };
                PopUpComponent.prototype.salvar = function () {
                    var _this = this;
                    debugger;
                    //Validação
                    var erro = false;
                    ...
                    if (!erro) {
                        if (this.data.titulo == 'Entrada') {
                            var entrada = new _shared_model__WEBPACK_IMPORTED_MODULE_3__["Entrada"];
                            entrada.idEntrada = 0;
                            ...
                            this.produtosService.entrada(entrada).subscribe(function () {
                                _this.toastr.success('Sucesso', 'Entrada cadastrada com sucesso');
                                _this.dialogRef.close();
                            });
                        }
                        else if (this.data.titulo == 'Saída') {
                            var saida = new _shared_model__WEBPACK_IMPORTED_MODULE_3__["Saida"];
                            saida.idProduto = this.data.idProduto;
                            saida.quantidade = this.quantidade;
                            saida.valorTotal = this.valor;
                            this.produtosService.saida(saida).subscribe(function () {
                                _this.toastr.success('Sucesso', 'Saída cadastrada com sucesso');
                                _this.dialogRef.close();
                            });
                        }
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProdutosComponent = /** @class */ (function () {
                function ProdutosComponent(service, dialog, route) {
                    this.service = service;
                    this.dialog = dialog;
                    this.route = route;
                    this.isMobile = document.body.clientWidth < 670;
                ...
                ProdutosComponent.prototype.abrirPopUp = function (idProduto, tituloPopUp) {
                    var _this = this;
                    var dialogRef = this.dialog.open(_pop_up_pop_up_component__WEBPACK_IMPORTED_MODULE_3__["PopUpComponent"], { width: '250px', data: { titulo: tituloPopUp, idProduto: idProduto } });
                    dialogRef.afterClosed().subscribe(function () {
                        _this.paginar(null);
                    });
                };
                ProdutosComponent.prototype.abrirPopUpExclusao = function (idProduto) {
                    var _this = this;
                    var dialogRef = this.dialog.open(_pop_up_confirm_pop_up_confirm_component__WEBPACK_IMPORTED_MODULE_4__["PopUpConfirmComponent"], { width: '250px', data: { idProduto: idProduto, tipoExclusao: 'produto' } });
                    dialogRef.afterClosed().subscribe(function () { return _this.paginar(null); });
                };
                ProdutosComponent.prototype.onResize = function (event) {
                    this.isMobile = event.target.innerWidth < 670;
                    this.verificaColunas();
                };
                ProdutosComponent.prototype.ngOnChanges = function () {
                    this.paginar(null);
                    this.verificaColunas();
                };
                ...
                ProdutosComponent.prototype.paginar = function (event) {
                    var _this = this;
                    var inicial;
                    var final;
                    if (event == null) {
                    ...
                    this.service.consultarProdutos(this.idCliente).subscribe(function (data) {
                        _this.produtos = data;
                        _this.produtosPaginados = data.slice(inicial, final);
                    });
                };
                ProdutosComponent.prototype.verificaColunas = function () {
                    if (this.isMobile)
            ...
            ProdutosComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsuarioService = /** @class */ (function () {
                ...
                UsuarioService.prototype.logar = function (login) {
                ...
                UsuarioService.prototype.consultarUsuario = function (idCliente) {
                    return this.http.get(this.baseUrl + 'ConsultarUsuarios', {
                        params: { idCliente: idCliente.toString() }, responseType: 'json'
                    });
                };
                UsuarioService.prototype.excluir = function (idUsuario) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsuariosComponent = /** @class */ (function () {
                function UsuariosComponent(usuarioService, dialog, router) {
                    this.usuarioService = usuarioService;
                    this.dialog = dialog;
                    this.router = router;
                    this.isMobile = document.body.clientWidth < 670;
                ...
                UsuariosComponent.prototype.onResize = function (event) {
                    this.isMobile = event.target.innerWidth < 670;
                    this.verificaColunas();
                };
                UsuariosComponent.prototype.ngOnChanges = function () {
                    this.paginar(null);
                    this.verificaColunas();
                };
                UsuariosComponent.prototype.abrirPopUpExclusao = function (idUsuario) {
                    var _this = this;
                    var dialogRef = this.dialog.open(_pop_up_confirm_pop_up_confirm_component__WEBPACK_IMPORTED_MODULE_2__["PopUpConfirmComponent"], { width: '250px', data: { idUsuario: idUsuario, tipoExclusao: 'usuario' } });
                    dialogRef.afterClosed().subscribe(function () { return _this.paginar(null); });
                };
                UsuariosComponent.prototype.paginar = function (event) {
                    var _this = this;
                    var inicial;
                    var final;
                    if (event == null) {
                    ...
                    this.usuarioService.consultarUsuario(this.idCliente).subscribe(function (data) {
                        console.log(data);
                        _this.usuarios = data;
                        _this.usuariosPaginados = data.slice(inicial, final);
                    });
                };
                UsuariosComponent.prototype.verificaColunas = function () {
                    if (this.isMobile)
                        this.displayedColumns = ['nome', 'login', 'controles'];
                    else
                        this.displayedColumns = ['nome', 'login', 'controles'];
                };
                UsuariosComponent.prototype.cadastroUsuario = function () {
